...
// TODO: You are sending back the tile rotation rather than the tile value
// to the Love game. So, figure out how not to do that.
// I think it's something as simple as creating a tile mapping that has each
// string associated with a value. I think this code does that somewhere, 
// but figure it out.
...
class modSimpleTiledModel : Model
{
    Dictionary<string, int> tileMappings;
    List<int[]> tiles;
    List<string> tilenames;
    int tilesize;
    bool blackBackground;

    public modSimpleTiledModel(string filepath, string name, string subsetName, int width, int height, bool periodic, bool blackBackground, Heuristic heuristic) : base(width, height, 1, periodic, heuristic)
    {
    ...
    // TODO: Get a mapping of tile name to number
    // Use that mapping for generating the results
